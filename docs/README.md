...
├── DEVIATIONS.md              # 30 spec deviations, all documented
...
| **DEVIATIONS.md** | Every place where the actual build differs from the original spec. 30 entries with root cause, fix, and rationale. Summary table at the bottom. | Technical review, grading |
...
- **Reviewing what changed from the plan?** Read `DEVIATIONS.md` — 29 documented differences with explanations.
