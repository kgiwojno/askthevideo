...
| **DEVIATIONS.md** | Every place where the actual build differs from the original spec. 37 entries with root cause, fix, and rationale. Summary table at the bottom. | Technical review, grading |
